...
class dataReader:
    def __init__(self, param, run):
        ...
        direct = '/Users/messi/Documents/summer18/Code/RealData_ZeroOne1_ori/data/'
        ...
        if param.name_data in param.name_list:
...
#         #direct = '/Users/messi/Documents/Year1/summer18/Code/RealData_ZeroOne1/data/'
#         # direct = direct + param.name_data + '/'
#         # os.getcwd()
#         # os.path.exists(direct)
...
#         direct = '/Users/messi/Documents/Year1/summer18/test_data/'
#         os.getcwd()
#         os.path.exists(direct)
#         matfile = sio.loadmat(direct + param.name_data + '.mat', squeeze_me=True, struct_as_record=False)

#         """ convert sparse arrays to numpy arrays """

#         # self.X_train_p = matfile['data_tra_DFO'].X.toarray()      # positive training
#         # self.X_train_n = matfile['data_tra_DFO'].Y.toarray()      # negative training
#         self.instance_matrix = matfile['data'].X.toarray()
#         self.label_vector = matfile['data'].y.toarray()

#         pos_idx = np.where(self.label_vector > 0)[0]
#         neg_idx = np.where(self.label_vector < 0)[0]
#         self.X_train_p = self.instance_matrix[pos_idx, :]      # positive training
#         self.X_train_n = self.instance_matrix[neg_idx, :]      # negative training
#         print('pos shape is')
#         print(self.X_train_p.shape)
...
#         print(float(self.N_train_p) / self.N_train_n)
...
#         self.X_test_p = self.X_train_p    # positive test
#         self.X_test_n = self.X_train_n    # negative test
#         [self.N_test_p, d] = self.X_test_p.shape
#         [self.N_test_n, d] = self.X_test_n.shape
#         self.N_test = self.N_test_p + self.N_test_n
#         param.dim = d
...
#         self.X_train_p = np.append(self.X_train_p, np.ones((self.N_train_p, 1)), 1)
#         self.X_train_n = np.append(self.X_train_n, np.ones((self.N_train_n, 1)), 1)
#         self.X_test_p = self.X_train_p
#         self.X_test_n = self.X_train_n
#         # self.X_test_p = np.append(self.X_test_p, np.ones((self.N_test_p, 1)), 1)
#         # self.X_test_n = np.append(self.X_test_n, np.ones((self.N_test_n, 1)), 1)
